...
fn simple() {
    ...
    assert_eq!(
        ...
        Symbol {
            path: Path {
                name: UnqualifiedPath(NestedPath::Literal(Literal { start: 1, end: 2 }),),
                scope: Scope(vec![]),
            },
            tipe: Type::Function(Function {
...
fn question_to_pointer_to_data() {
    eq!("?var@@3?DPBHC" => "int const * const volatile var");
}

#[test]
fn question_to_reference_to_data() {
    eq!("?var@@3?DABHC" => "int const & const volatile var");
}
...
#[test]
fn cast_operator1() {
    eq!("??Bname0@@QEBAIXZ" => "public: __cdecl name0::operator unsigned int(void)");
}

#[test]
fn cast_operator2() {
    eq!("??Bname0@@QEBAVname1@@XZ" => "public: __cdecl name0::operator class name1(void)");
}

#[test]
fn cast_operator3() {
    eq!("??Bname0@@QEBAPEBVname1@@XZ" =>
        "public: __cdecl name0::operator class name1 const *(void)");
}

#[test]
fn cast_operator4() {
    eq!("??Bname0@name1@@QEAAPEAVname2@name3@@XZ" =>
        "public: __cdecl name1::name0::operator class name3::name2 *(void)");
}

#[test]
fn cast_operator5() {
    eq!("??Bname0@@QEBAP6AP6AXXZXZXZ" =>
...
fn derelict4related_diff1() {
    eq!("?name0@@3QAY01$$CBEA" => "unsigned char const ( * const name0)[2]");
}
...
fn cvmodifiers_b_on_q() {
    eq!("?VarName@@3QBHA" => "int const * const VarName");
}
...
fn cvmodifiers_a_on_q_to_arrayof_a_on_h() {
    eq!("?VarName@@3QAY01HA" => "int ( * const VarName)[2]");
}
