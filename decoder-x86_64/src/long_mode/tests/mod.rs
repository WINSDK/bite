...
fn test_invalid_under(dekoder: &Decoder, data: &[u8]) {
...
fn modrm_decode() {
    ...
    test_display(
        ...
        "xor eax, dword [r13 + 0x11]",
    );
    test_display(
        &[0x33, 0x84, 0xa5, 0x11, 0x22, 0x33, 0x44],
        "xor eax, dword [rbp + 0x44332211]",
    );
    test_display(
        &[0x41, 0x33, 0x84, 0xa5, 0x11, 0x22, 0x33, 0x44],
        "xor eax, dword [r13 + 0x44332211]",
    );
    test_display(
...
fn mmx() {
    ...
    test_display(
        ...
        "pmulhw mm7, qword [rip + 0x77ccbbaa]",
    );
...
fn aesni() {
    ...
    test_instr(
        ...
        "aeskeygenassist xmm1, xmmword [rdi], 0xaa",
    );
    test_instr(
...
fn sse2() {
    ...
    test_instr(
        ...
        "movsd xmm1, qword [rdi + rax * 8]",
    );
    test_instr(
        &[0xf2, 0x0f, 0x11, 0x0c, 0xc7],
        "movsd qword [rdi + rax * 8], xmm1",
    );
    test_instr(
        &[0x66, 0x0f, 0x11, 0x0c, 0xc7],
        "movupd xmmword [rdi + rax * 8], xmm1",
    );
    ...
    test_instr(
        ...
        "shufpd xmm8, xmmword [r11], 0x8",
    );
    test_instr(
        &[0x66, 0x0f, 0xc6, 0x03, 0x08],
        "shufpd xmm0, xmmword [rbx], 0x8",
    );
...
fn sse4_2() {
    ...
    test_instr(
        ...
        "pcmpestrm xmm0, xmmword [rsi], 0x54",
    );
    test_instr(
    ...
    test_instr(
        ...
        "pcmpestri xmm0, xmmword [rsi], 0x54",
    );
    test_instr(
    ...
    test_instr(
        ...
        "pcmpistrm xmm0, xmmword [rsi], 0x54",
    );
    test_instr(
    ...
    test_instr(
        ...
        "pcmpistri xmm0, xmmword [rsi], 0x54",
    );
}
...
fn ssse3() {
    ...
    test_instr(
        ...
        "palignr xmm0, xmmword [rsi], 0x30",
    );
    test_instr(
        &[0x0f, 0x3a, 0x0f, 0x06, 0x30],
        "palignr mm0, qword [rsi], 0x30",
    );
}
...
fn zerofae() {
    ...
    test_display(
        ...
        "xrstors64 ptr [r12 + r12 * 1 + 0x40]",
    );
    test_display(
        &[0x4f, 0x0f, 0xc7, 0x64, 0x24, 0x40],
        "xsavec64 ptr [r12 + r12 * 1 + 0x40]",
    );
    test_display(
        &[0x4f, 0x0f, 0xc7, 0x6c, 0x24, 0x40],
        "xsaves64 ptr [r12 + r12 * 1 + 0x40]",
    );
    test_display(
        &[0x0f, 0xc7, 0x74, 0x24, 0x40],
        "vmptrld qword [rsp + 0x40]",
    );
    test_display(
        &[0x0f, 0xc7, 0x7c, 0x24, 0x40],
        "vmptrst qword [rsp + 0x40]",
    );
...
fn arithmetic() {
    ...
    test_display(
        ...
        "imul rax, qword [r11 + 0x6f], 0x656c706d",
    );
...
fn sse() {
    test_display(
        ...
        "movss xmm1, dword [rdi + rax * 8]",
    );
    test_display(
        &[0xf3, 0x0f, 0x11, 0x0c, 0xc7],
        "movss dword [rdi + rax * 8], xmm1",
    );
    ...
    test_display(
        ...
        "cvttps2dq xmm8, xmmword [r9]",
    );
    test_display(
        &[0x67, 0x4f, 0x0f, 0x5b, 0x01],
        "cvtdq2ps xmm8, xmmword [r9d]",
    );
    ...
    test_display(
        ...
        "cmpss xmm8, xmm11, 0x8",
    );
    test_display(
        &[0xf3, 0x4f, 0x0f, 0xc2, 0x03, 0x08],
        "cmpss xmm8, dword [r11], 0x8",
    );
}
...
fn control_flow() {
    ...
    test_display(
        ...
        "call qword [rip + 0x24727e]",
    );
    test_display(
        &[0xff, 0x24, 0xcd, 0x70, 0xa0, 0xbc, 0x01],
        "jmp qword [rcx * 8 + 0x1bca070]",
    );
...
fn bmi1() {
    ...
    test_display_under(
        ...
        "andn eax, ebx, dword [r9]",
    );
    test_display_under(
        &bmi1,
        &[0xc4, 0xc2, 0xe0, 0xf2, 0x01],
        "andn rax, rbx, qword [r9]",
    );
    test_display_under(
        &bmi1,
    ...
    test_display_under(
        ...
        "bextr eax, dword [r9], ebx",
    );
    test_display_under(
        &bmi1,
        &[0xc4, 0xc2, 0xe0, 0xf7, 0x01],
        "bextr rax, qword [r9], rbx",
    );
}
...
fn bmi2() {
    ...
    test_display_under(
        ...
        "rorx eax, dword [r9], 0x5",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xc3, 0xfb, 0xf0, 0x01, 0x05],
        "rorx rax, qword [r9], 0x5",
    );
    ...
    test_display_under(
        ...
        "pdep eax, ebx, dword [rdi]",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xe2, 0xe3, 0xf5, 0x07],
        "pdep rax, rbx, qword [rdi]",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xe2, 0x63, 0xf6, 0x07],
        "mulx eax, ebx, dword [rdi]",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xe2, 0xe3, 0xf6, 0x07],
        "mulx rax, rbx, qword [rdi]",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xc2, 0x63, 0xf7, 0x01],
        "shrx eax, dword [r9], ebx",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xc2, 0xe3, 0xf7, 0x01],
        "shrx rax, qword [r9], rbx",
    );
    ...
    test_display_under(
        ...
        "pext eax, ebx, dword [rdi]",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xe2, 0xe2, 0xf5, 0x07],
        "pext rax, rbx, qword [rdi]",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xc2, 0x62, 0xf7, 0x01],
        "sarx eax, dword [r9], ebx",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xc2, 0xe2, 0xf7, 0x01],
        "sarx rax, qword [r9], rbx",
    );
    ...
    test_display_under(
        ...
        "bzhi eax, dword [rdi], ebx",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xe2, 0xe0, 0xf5, 0x07],
        "bzhi rax, qword [rdi], rbx",
    );
    ...
    test_display_under(
        ...
        "shlx eax, dword [r9], ebx",
    );
    test_display_under(
        &bmi2,
        &[0xc4, 0xc2, 0xe1, 0xf7, 0x01],
        "shlx rax, qword [r9], rbx",
    );
}
...
fn misc() {
    ...
    test_display(
        ...
        "lea rsp, qword [rdi + rax * 8 + 0x12000020]",
    );
    ...
    test_display(
        &[0xf3, 0x48, 0xa5],
        "rep movs qword es:[rdi], qword ds:[rsi]",
    );
...
fn evex() {
    test_display(
        &[0x62, 0xe1, 0x7c, 0x00, 0x14, 0x0a],
        "vunpcklps xmm17, xmm16, xmmword [rdx]",
    );
    test_display(
        &[0x62, 0xe1, 0x7c, 0x08, 0x14, 0x0a],
        "vunpcklps xmm17, xmm0, xmmword [rdx]",
    );
    test_display(
        &[0x62, 0x01, 0x7c, 0x00, 0x14, 0xca],
        "vunpcklps xmm25, xmm16, xmm26",
    );
    test_display(
        &[0x62, 0xf2, 0x7d, 0x48, 0x2a, 0x44, 0x40, 0x01],
        "vmovntdqa zmm0, zmmword [rax + rax * 2 + 0x40]",
    );
    test_display(
        &[0x62, 0xf2, 0x7d, 0x08, 0x2a, 0x44, 0x40, 0x01],
        "vmovntdqa xmm0, xmmword [rax + rax * 2 + 0x10]",
    );
    test_invalid(&[0x62, 0xf2, 0x7d, 0x1d, 0x66, 0x50, 0x01, 0x11]);
    test_display(
        &[0x62, 0x12, 0x7d, 0x06, 0xa0, 0x04, 0x2f],
        "vpscatterdd dword [r15 + xmm29 * 1], k6, xmm8",
    );
    test_display(
        &[0x62, 0x12, 0x7d, 0x06, 0xa0, 0x14, 0x0f],
        "vpscatterdd dword [r15 + xmm25 * 1], k6, xmm10",
    );
    test_display(
        &[0x62, 0x12, 0x7d, 0x26, 0xa0, 0x14, 0x0f],
        "vpscatterdd dword [r15 + ymm25 * 1], k6, ymm10",
    );
    test_display(
        &[0x62, 0x12, 0x7d, 0x46, 0xa0, 0x14, 0x0f],
        "vpscatterdd dword [r15 + zmm25 * 1], k6, zmm10",
    );

    test_display(
        &[0x62, 0x12, 0xfd, 0x46, 0xa0, 0x14, 0x0f],
        "vpscatterdq qword [r15 + zmm25 * 1], k6, zmm10",
    );
    test_display(
        &[0x62, 0x12, 0x7d, 0x46, 0xa1, 0x14, 0x0f],
        "vpscatterqd dword [r15 + zmm25 * 1], k6, zmm10",
    );
    test_display(
        &[0x62, 0x12, 0xfd, 0x46, 0xa1, 0x14, 0x0f],
        "vpscatterqq qword [r15 + zmm25 * 1], k6, zmm10",
    );
}
...
fn vex() {
    ...
    test_avx2(
        ...
        "vinserti128 ymm9, ymm8, xmm10, 0x77",
    );
    test_invalid(&[0xc4, 0b000_00011, 0b1_0111_101, 0x18, 0b11_001_010, 0x77]);
    test_avx2(
        &[0xc4, 0b000_00011, 0b0_1111_101, 0x39, 0b11_001_010, 0x77],
        "vextracti128 xmm10, ymm9, 0x77",
    );
    test_invalid(&[0xc4, 0b000_00011, 0b0_1111_001, 0x19, 0b11_001_010, 0x77]);
    test_invalid(&[0xc4, 0b000_00011, 0b1_1111_101, 0x19, 0b11_001_010, 0x77]);
    ...
    test_instr(
        ...
        "vpblendvb xmm9, xmm8, xmm10, xmm7",
    );
    test_avx2(
        &[0xc4, 0b000_00011, 0b0_0111_101, 0x4c, 0b11_001_010, 0x77],
        "vpblendvb ymm9, ymm8, ymm10, ymm7",
    );
    ...
    test_instr_vex_aesni(
        ...
        "vaeskeygenassist xmm9, xmm10, 0x77",
    );
    ...
    test_instr(
        ...
        "vpermps ymm9, ymm0, ymm10",
    );
    test_instr(
        &[0xc4, 0b000_00010, 0b0_1111_101, 0x16, 0b00_001_010],
        "vpermps ymm9, ymm0, ymmword [r10]",
    );
    ...
    test_instr(
        ...
        "vbroadcastss xmm9, dword [r10]",
    );
    test_instr(
        &[0xc4, 0b000_00010, 0b0_1111_101, 0x18, 0b00_001_010],
        "vbroadcastss ymm9, dword [r10]",
    );
    ...
    test_instr(
        ...
        "vbroadcastf128 ymm9, xmmword [r10]",
    );
    ...
    test_instr(
        ...
        "vbroadcasti128 ymm9, xmmword [r10]",
    );
    ...
    test_instr(
        ...
        "vmovhlps xmm9, xmm8, xmm10",
    );
    test_instr(
        &[0xc4, 0b000_00001, 0b1_0111_000, 0x12, 0b00_001_010],
        "vmovlps xmm9, xmm8, qword [r10]",
    );
    ...
    test_instr(
        ...
        "vmovsldup xmm9, xmmword [r10]",
    );
    test_instr(
        &[0xc4, 0b000_00001, 0b1_1111_110, 0x12, 0b00_001_010],
        "vmovsldup ymm9, ymmword [r10]",
    );
    test_instr(
    ...
    test_instr(
        ...
        "vmovntps xmmword [r10], xmm9",
    );
    test_instr(
        &[0xc4, 0b000_00001, 0b1_1111_100, 0x2b, 0b00_001_010],
        "vmovntps ymmword [r10], ymm9",
    );
    ...
    test_instr(
        ...
        "vmovntpd xmmword [r10], xmm9",
    );
    test_instr(
        &[0xc4, 0b000_00001, 0b1_1111_101, 0x2b, 0b00_001_010],
        "vmovntpd ymmword [r10], ymm9",
    );
    ...
    test_instr(
        ...
        "vcvttsd2si r9, qword [r10]",
    );
    test_instr(
        &[0xc4, 0b000_00001, 0b0_1111_111, 0x2c, 0b00_001_010],
        "vcvttsd2si r9d, dword [r10]",
    );
    test_instr(
    ...
    test_instr(
        ...
        "vcvtps2pd xmm9, qword [r10]",
    );
    test_instr(
        &[0xc4, 0b000_00001, 0b1_1111_100, 0x5a, 0b00_001_010],
        "vcvtps2pd ymm9, xmmword [r10]",
    );
    test_instr(
    ...
    test_instr(
        ...
        "vpshufb xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x00, 0x0f],
        "vpshufb ymm9, ymm1, ymmword [r15]",
    );
    ...
    test_instr(
        ...
        "vphaddw xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x01, 0x0f],
        "vphaddw ymm9, ymm1, ymmword [r15]",
    );
    ...
    test_instr(
        ...
        "vphaddd xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x02, 0x0f],
        "vphaddd ymm9, ymm1, ymmword [r15]",
    );
    ...
    test_instr(
        ...
        "vphaddsw xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x03, 0x0f],
        "vphaddsw ymm9, ymm1, ymmword [r15]",
    );
    test_instr(
    ...
    test_instr(
        ...
        "vpmaddubsw xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x04, 0x0f],
        "vpmaddubsw ymm9, ymm1, ymmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x71, 0x04, 0xcd],
        "vpmaddubsw xmm9, xmm1, xmm13",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x04, 0xcd],
        "vpmaddubsw ymm9, ymm1, ymm13",
    );
    test_instr(
        &[0xc4, 0x02, 0x71, 0x05, 0x0f],
        "vphsubw xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x05, 0x0f],
        "vphsubw ymm9, ymm1, ymmword [r15]",
    );
    ...
    test_instr(
        ...
        "vphsubd xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x06, 0x0f],
        "vphsubd ymm9, ymm1, ymmword [r15]",
    );
    ...
    test_instr(
        ...
        "vphsubsw xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x07, 0x0f],
        "vphsubsw ymm9, ymm1, ymmword [r15]",
    );
    test_instr(
    ...
    test_instr(
        ...
        "vpsignb xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x08, 0x0f],
        "vpsignb ymm9, ymm1, ymmword [r15]",
    );
    ...
    test_instr(
        ...
        "vpsignw xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x09, 0x0f],
        "vpsignw ymm9, ymm1, ymmword [r15]",
    );
    ...
    test_instr(
        ...
        "vpsignd xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x0a, 0x0f],
        "vpsignd ymm9, ymm1, ymmword [r15]",
    );
    ...
    test_instr(
        ...
        "vpmulhrsw xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x0b, 0x0f],
        "vpmulhrsw ymm9, ymm1, ymmword [r15]",
    );
    test_instr(
    ...
    test_instr(
        ...
        "vpermilps xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x0c, 0x0f],
        "vpermilps ymm9, ymm1, ymmword [r15]",
    );
    test_instr(
    ...
    test_instr(
        ...
        "vpermilpd xmm9, xmm1, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x75, 0x0d, 0x0f],
        "vpermilpd ymm9, ymm1, ymmword [r15]",
    );
    test_instr(
    ...
    test_instr(
        ...
        "vtestps xmm9, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x7d, 0x0e, 0x0f],
        "vtestps ymm9, ymmword [r15]",
    );
    ...
    test_instr(
        ...
        "vtestpd xmm9, xmmword [r15]",
    );
    test_instr(
        &[0xc4, 0x02, 0x7d, 0x0f, 0x0f],
        "vtestpd ymm9, ymmword [r15]",
    );
    ...
    test_instr(
        ...
        "vpgatherdd ymm0, dword [rcx + ymm2 * 2], ymm3",
    );
    test_instr(
        &[0xc4, 0xe2, 0xe5, 0x90, 0x04, 0x51],
        "vpgatherdq ymm0, qword [rcx + ymm2 * 2], ymm3",
    );
    test_instr(
        &[0xc4, 0xe2, 0x65, 0x91, 0x04, 0x51],
        "vpgatherqd xmm0, dword [rcx + ymm2 * 2], xmm3",
    );
    test_instr(
        &[0xc4, 0xe2, 0xe5, 0x91, 0x04, 0x51],
        "vpgatherqq ymm0, qword [rcx + ymm2 * 2], ymm3",
    );
    test_instr(
    ...
    test_instr(
        ...
        "vpextrb eax, xmm2, 0xa",
    );
    test_instr(
        &[0xc4, 0xe3, 0x79, 0x14, 0x10, 0x0a],
        "vpextrb byte [rax], xmm2, 0xa",
    );
    ...
    test_instr(
        ...
        "vinserti128 ymm7, ymm1, xmmword [r10 + rdx * 1 + 0x5], 0x1",
    );
    test_instr(
        &[0xc4, 0xc3, 0x75, 0x42, 0x7c, 0x12, 0x05, 0x61],
        "vmpsadbw ymm7, ymm1, ymmword [r10 + rdx * 1 + 0x5], 0x61",
    );
    test_instr(
        &[0xc4, 0xc3, 0x75, 0x46, 0x7c, 0x12, 0x05, 0x61],
        "vperm2i128 ymm7, ymm1, ymmword [r10 + rdx * 1 + 0x5], 0x61",
    );
    test_instr(
        &[0xc4, 0xc3, 0x75, 0x4a, 0x7c, 0x12, 0x05, 0x61],
        "vblendvps ymm7, ymm1, ymmword [r10 + rdx * 1 + 0x5], ymm6",
    );
    test_instr(
        &[0xc4, 0xc3, 0x71, 0x4a, 0x7c, 0x12, 0x05, 0x61],
        "vblendvps xmm7, xmm1, xmmword [r10 + rdx * 1 + 0x5], xmm6",
    );
    test_instr(
        &[0xc4, 0xc3, 0x71, 0x4a, 0xdc, 0x61],
        "vblendvps xmm3, xmm1, xmm12, xmm6",
    );
    test_instr(
        &[0xc4, 0xc3, 0x75, 0x4b, 0x7c, 0x12, 0x05, 0x61],
        "vblendvpd ymm7, ymm1, ymmword [r10 + rdx * 1 + 0x5], ymm6",
    );
    test_instr(
        &[0xc4, 0xc3, 0x71, 0x4b, 0x7c, 0x12, 0x05, 0x61],
        "vblendvpd xmm7, xmm1, xmmword [r10 + rdx * 1 + 0x5], xmm6",
    );
    test_instr(
        &[0xc4, 0xc3, 0x71, 0x4b, 0xdc, 0x61],
        "vblendvpd xmm3, xmm1, xmm12, xmm6",
    );
    test_instr(
        &[0xc4, 0xc3, 0x71, 0x4c, 0x7c, 0x12, 0x05, 0x61],
        "vpblendvb xmm7, xmm1, xmmword [r10 + rdx * 1 + 0x5], xmm6",
    );

    test_instr(
        &[0xc5, 0xc9, 0xf1, 0x0f],
        "vpsllw xmm1, xmm6, xmmword [rdi]",
    );
    test_instr(&[0xc5, 0xc9, 0xf1, 0xcf], "vpsllw xmm1, xmm6, xmm7");
    test_instr(
        &[0xc5, 0xcd, 0xf1, 0x0f],
        "vpsllw ymm1, ymm6, xmmword [rdi]",
    );
    test_instr(&[0xc5, 0xcd, 0xf1, 0xcf], "vpsllw ymm1, ymm6, xmm7");
    test_instr(
        &[0xc5, 0xc9, 0xf2, 0x0f],
        "vpslld xmm1, xmm6, xmmword [rdi]",
    );
    test_instr(&[0xc5, 0xc9, 0xf2, 0xcf], "vpslld xmm1, xmm6, xmm7");
    test_instr(
        &[0xc5, 0xcd, 0xf2, 0x0f],
        "vpslld ymm1, ymm6, xmmword [rdi]",
    );
    test_instr(&[0xc5, 0xcd, 0xf2, 0xcf], "vpslld ymm1, ymm6, xmm7");
    test_instr(
        &[0xc5, 0xc9, 0xf3, 0x0f],
        "vpsllq xmm1, xmm6, xmmword [rdi]",
    );
    test_instr(&[0xc5, 0xc9, 0xf3, 0xcf], "vpsllq xmm1, xmm6, xmm7");
    test_instr(
        &[0xc5, 0xcd, 0xf3, 0x0f],
        "vpsllq ymm1, ymm6, xmmword [rdi]",
    );
    test_instr(&[0xc5, 0xcd, 0xf3, 0xcf], "vpsllq ymm1, ymm6, xmm7");

    test_instr(
        &[0xc5, 0xf1, 0xc4, 0xd8, 0x78],
        "vpinsrw xmm3, xmm1, eax, 0x78",
    );
    test_instr(
        &[0xc5, 0xf1, 0xc4, 0x18, 0x78],
        "vpinsrw xmm3, xmm1, word [rax], 0x78",
    );

    test_instr(
        &[0xc5, 0xe0, 0x54, 0x03],
        "vandps xmm0, xmm3, xmmword [rbx]",
    );
    test_instr(
        &[0xc5, 0xe1, 0x54, 0x03],
        "vandpd xmm0, xmm3, xmmword [rbx]",
    );
    test_instr(
        &[0xc5, 0xe0, 0x55, 0x03],
        "vandnps xmm0, xmm3, xmmword [rbx]",
    );
    test_instr(
        &[0xc5, 0xe1, 0x55, 0x03],
        "vandnpd xmm0, xmm3, xmmword [rbx]",
    );
    ...
    test_instr(
        ...
        "vpmaxuw ymm2, ymm13, ymmword [rcx + r15 * 4]",
    );
}
...
fn sha() {
    test_display(
        ...
        "sha1rnds4 xmm2, xmmword [rdx], 0x40",
    );
    test_display(
        &[0x0f, 0x3a, 0xcc, 0x12, 0xff],
        "sha1rnds4 xmm2, xmmword [rdx], 0xff",
    );
...
fn mishegos_finds() {
    ...
    test_display(
        ...
        "paddb mm5, qword [rdi - 0x40dac7c0]",
    );
    ...
    test_display(
        &[0x62, 0x42, 0xd5, 0x9d, 0x97, 0xf6],
        "vfmsubadd132pd zmm30{k5}{z}{rne-sae}, zmm5, zmm14",
    );
    test_invalid(&[0x67, 0x66, 0x42, 0x0f, 0x01, 0xfe]);
    test_display(
        &[0x62, 0x52, 0x05, 0xff, 0xad, 0xfd],
        "vfnmadd213ss xmm15{k7}{z}{rz-sae}, xmm15, xmm13",
    );
    ...
    test_invalid(&[
        0x2e, 0x2e, 0xf2, 0x36, 0x40, 0x0e, 0xb2, 0xdb, 0x42, 0xd6, 0xa3, 0x16,
    ]);
    test_invalid(&[
        0x2e, 0xf2, 0x36, 0x40, 0x0f, 0xb2, 0xdb, 0x42, 0xd6, 0xa3, 0x16,
    ]);
    test_invalid(&[0x3e, 0x3e, 0x3e, 0x66, 0x4b, 0x35, 0x58, 0x3e]);
    test_display(
        &[0xf2, 0xf3, 0x66, 0x65, 0x4f, 0x25, 0x9b, 0x5e, 0xda, 0x44],
        "and rax, 0x44da5e9b",
    );
    ...
    */
    ...
    test_display(
        ...
        "movdir64b ebp, zmmword [ebp + 0x729080b]",
    );
    test_display(
    ...
    test_display(
        ...
        "pclmulqdq xmm9, xmmword [rax + 0x3526adb3], 0x75",
    );
    test_display(
        &[0x4c, 0x0f, 0xff, 0x6b, 0xac],
        "ud0 r13d, dword [rbx - 0x54]",
    );
    ...
    test_display(
        ...
        "enqcmd r8, zmmword [r11 + 0x3f9d1c09]",
    );
    test_display(
        &[0x3e, 0x64, 0xf3, 0x64, 0x0f, 0x38, 0xf8, 0x72, 0x54],
        "enqcmds rsi, zmmword fs:[rdx + 0x54]",
    );
...
fn threednow() {
    ...
    test_display(
        ...
        "pfmax mm4, qword [rbx + rdx * 4 - 0x6d]",
    );
    test_display(
        &[0x26, 0x36, 0x0f, 0x0f, 0x70, 0xfb, 0x0c],
        "pi2fw mm6, qword [rax - 0x5]",
...
fn gfni() {
    test_display(
        ...
        "gf2p8affineinvqb xmm15, xmmword fs:[rdx - 0x45fbdced], 0x6b",
    );
    test_display(
        &[
            0x66, 0x36, 0x0f, 0x3a, 0xce, 0x8c, 0x56, 0x9e, 0x82, 0xd1, 0xbe, 0xad,
        ],
        "gf2p8affineqb xmm1, xmmword [rsi + rdx * 2 - 0x412e7d62], 0xad",
    );
    test_display(
        &[0x66, 0x4e, 0x0f, 0x38, 0xcf, 0x1c, 0x54],
        "gf2p8mulb xmm11, xmmword [rsp + r10 * 2]",
    );
}
...
fn from_reports() {
    ...
    test_display(
        ...
        "vpshufb ymm3{k4}{z}, ymm2, ymmword [rcx - 0xb20]",
    );
    test_display(
        &[0x62, 0xf2, 0xfd, 0x0f, 0x8a, 0x62, 0xf2],
        "vcompresspd xmmword [rdx - 0x70]{k7}, xmm4",
    );
