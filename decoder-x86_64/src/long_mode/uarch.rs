pub mod amd {
    ...
    //! from
    //! [https://en.wikipedia.org/wiki/AMD_Accelerated_Processing_Unit#Feature_overview](https://docs.rs/yaxpeax-x86/0.0.12/x86_64/protected_mode/uarch/intel/index.html)
    //! and
    //! [https://en.wikipedia.org/wiki/Template:AMD_x86_CPU_features](https://docs.rs/yaxpeax-x86/0.0.12/x86_64/protected_mode/uarch/intel/index.html).
...
pub mod intel {
    ...
    pub fn netburst() -> Decoder {
        Decoder::minimal().with_cmov().with_cmpxchg16b().with_sse3()
    }
    ...
    /// following:
    /// ```
    /// x86_64::long_mode::uarch::intel::skylake()
    ///     .with_avx512_f()
    ///     .with_avx512_dq();
    /// ```
